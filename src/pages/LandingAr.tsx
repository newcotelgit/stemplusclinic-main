  ...
  return (
    <section className="py-24 bg-secondary/30">
      <div className="max-w-4xl mx-auto px-5">
        ...
        <div className="rounded-2xl bg-white shadow-md p-8 sm:p-10 sm:flex sm:gap-10">
          <div className="sm:w-48 shrink-0 flex flex-col items-center text-center mx-auto sm:mx-0">
            <img
              src={mohammedMuwahed}
              alt="محمد موحد"
              loading="lazy"
              decoding="async"
              className="w-40 sm:w-full rounded-xl object-cover object-center"
            />

            <ul className="mt-6 space-y-3 text-sm w-full">
              <li>
                <a
          ...
          <div className="mt-8 sm:mt-0 flex-1 text-center sm:text-right">
